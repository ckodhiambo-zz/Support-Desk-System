                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 20px; line-height: 140%;">
                                                        <strong>Precision Desk Notification!</strong>
                                                    </p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 20px; line-height: 28px;"><strong><span
                                                                    style="line-height: 28px; font-size: 20px;">Re-Opened
                                                                                Ticket Notification!
                                                                            </span></strong>
                                                                    </span>
                                                    </p>
                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 22px; line-height: 35.2px;">Dear
                                                                        <strong>{{$ticketItem->requester->name }},</strong></span>
                                                    </p>
                                                    <p
                                                        style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                                    <span
                                                                        style="font-size: 18px; line-height: 28.8px;">We
                                                                        notify you that your ticket <strong>TD-{{$ticketItem->id}}</strong>
                                                                        initially raised by you has been
                                                                        <strong>{{ $ticketItem->status->name }}</strong> and an email sent to our agent <strong>{{ $ticketItem->solver->name }}</strong>.
                                                                        The ticket status now stands us
                                                                        <strong>{{ $ticketItem->status->name }}</strong>. <br>
                                                                        <strong>NB: Kindly note that a ticket can only be re-opened once.</strong>
                                                                    </span>
                                                    </p>
                                                </div>
                                            </td>
                                    ...
                                    <table style="font-family:'Cabin',sans-serif;" role="presentation"
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div align="center">
                                                    <a href="{{ route('admin.my-ticket-detail', $ticketItem) }}" target="_blank"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:14px 44px 13px;line-height:120%;"><span
                                                                            style="font-size: 16px; line-height: 19.2px;"><strong><span
                                                                                    style="line-height: 19.2px; font-size: 16px;">Click
                                                                                    to View Ticket
                                                                                    Details</span></strong>
                                                                        </span>
                                                                    </span>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:2px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="line-height: 100%; font-size: 14px;"><span
                                                            style="font-size: 18px; line-height: 18px;">IT
                                                                        Helpdesk team</span>
                                                    </p>
                                                    <p style="line-height: 100%; font-size: 14px;">&nbsp;
                                                    </p>
