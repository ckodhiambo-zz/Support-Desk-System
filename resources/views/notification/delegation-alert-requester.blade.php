                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 20px; line-height: 28px;"><strong><span
                                                                    style="line-height: 28px; font-size: 20px;">Delegated
                                                                                Ticket
                                                                            </span></strong>
                                                                    </span>
                                                    </p>
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                                    <span
                                                                        style="font-size: 18px; line-height: 28.8px;">This
                                                                        is to notify you that your ticket <strong>TD-{{$ticket->id}}</strong> of
                                                                        subject <strong>{{$ticket->subject}}</strong> has been
                                                                        delegated to <strong>{{$ticket->solver->name}}</strong>. The delegation was initiated by <strong>{{ auth()->user()->name }}</strong>.
                                                                        Your ticket status is stands as <strong>{{$ticket->status->name}}</strong>.
                                                                        For more details, kindly click on the button
                                                                        below.</span>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                @if(Route::has('login'))
                                                    @auth
                                                        ...
                                                        @elseif(Auth::user()->user_type==='Agent')
                                                            <li class="dropdown"><a
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <a href="{{ route('agent.my-ticket-detail') }}">My
                                                                            Dashboard</a></li>
                                                    ...
                                                    @else
                                                        <li><a class="getstarted scrollto lg-bg-nabo"
