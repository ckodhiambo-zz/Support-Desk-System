                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 20px; line-height: 28px;"><strong><span
                                                                    style="line-height: 28px; font-size: 20px;">Pending Open
                                                                                Ticket!
                                                                            </span></strong>
                                                                    </span>
                                                    </p>
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 22px; line-height: 35.2px;">Hi
                                                                        <strong>{{$ticket->solver->name}},</strong></span>
                                                    </p>
                                                    <p
                                                        style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                                    <span
                                                                        style="font-size: 18px; line-height: 28.8px;">This
                                                                        is a polite follow up on a ticket <strong>{{$ticket->id}}</strong>
                                                                        of subject <strong>{{$ticket->subject}}</strong>
                                                                        that is yet to be actioned on.
                                                                        <br>
                                                                        The ticket status
                                                                        still reflects as <strong>{{$ticket->status->name}}</strong>
                                                                        and has an exceeded time limit of <strong>over
                                                                            15 minutes!</strong>
                                                                        <br>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:2px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="line-height: 100%; font-size: 14px;"><span
                                                            style="font-size: 18px; line-height: 18px;">Tier
                                                                        Data Limited</span>
                                                    </p>
                                                    <p style="line-height: 100%; font-size: 14px;">&nbsp;
                                                    </p>
