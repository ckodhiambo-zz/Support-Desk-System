                            ...
                            <div style="width: 100% !important;">
                                ...
                                <div
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0"
                                           role="presentation" style="font-family:'Cabin',sans-serif;" width="100%">
                                        <tbody>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 20px; line-height: 28px;"><strong><span
                                                                    style="line-height: 28px; font-size: 20px;">New Internal Nabo Ticket </span></strong>
                                  </span>
                                                    </p>
                                                </div>
                                ...
                                <div
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 18px; line-height: 28.8px;">A new Nabo ticket of subject <strong>- {{ $naboticket ['subject'] }} -</strong>&nbsp; has been raised by {{ auth()->user()->name }} from the Finance and Operations Department. Please click on the button below to view more details of the ticket. </span>
                                                    </p>
                                                </div>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div align="center">
                                                    ...
                                                    <![endif]-->
                                                    <a href="{{ route('nabo.edit-ticket', $naboticket) }}"
                                  ...
                                  <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td align="left"
                                                style="overflow-wrap:break-word;word-break:break-word;padding:2px;font-family:'Cabin',sans-serif;">
                                                ...
                                                <div
                                                    ...
                                                    <p style="line-height: 160%; font-size: 14px;"><span
                                                            style="font-size: 18px; line-height: 28.8px;">Kennedy Calvins</span>
                                                    </p>
                                                </div>
