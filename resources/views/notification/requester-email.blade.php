                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                        <span style="font-size: 18px; line-height: 28.8px;">Your ticket request<strong> (Ticket ID-#{{ $ticket->id }}) </strong>has been queued. The ticket status now stands as <strong>new</strong>. An agent will be assigned to you shortly. For more details on this ticket, kindly proceed and click the button below.</span>
                                                    </p>
                                                </div>
