...
<table
    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <div class="u-row-container" style="padding: 0px;background-color: transparent">
                <div class="u-row"
                     style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #142c3c;">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                        <!--[if (mso)|(IE)]>
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding: 0px;background-color: transparent;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:600px;">
                                        <tr style="background-color: #142c3c;"><![endif]-->
                            ...
                            <div style="width: 100% !important;">
                                ...
                                <div
                                    ...
                                    <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:18px 10px 10px;font-family:'Cabin',sans-serif;"
                                                align="left">

                                                <div
                                                    style="color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 18px; line-height: 25.2px;"><strong>P R E C I S I O N&nbsp; &nbsp;D E S K&nbsp; N O T I F I C A T I O N !</strong></span>
                                                    </p>
                                                </div>
                                    ...
                                    <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 17px;font-family:'Cabin',sans-serif;"
                                                align="left">
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                    style="line-height: 39.2px; font-size: 28px;"><span
                                                                        style="font-size: 20px; line-height: 28px;">Update on Ticket ID-#{{ $naboticket->id }}</span>&nbsp;</span>
                                  </strong>
                                  </span>
                                                    </p>
                                                </div>
                            ...
                            <div style="width: 100% !important;">
                                ...
                                <div
                                    ...
                                    <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:28px 55px 19px;font-family:'Cabin',sans-serif;"
                                                align="left">

                                                <div
                                                    style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 22px; line-height: 35.2px;"><span
                                                                style="font-size: 20px; line-height: 32px;">Hi {{$naboticket->requester->name}}</span>, </span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                        <span
                                                            style="font-size: 18px; line-height: 28.8px;">Your <strong>Ticket-ID-#{{$naboticket->id}}</strong> status now reflects as <strong>{{$naboticket->status->name}}</strong>. Kindly click on the button below to view more details. </span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                        ...
                                                        <tr>
                                                            <td style="font-family:'Cabin',sans-serif;" align="center">
                                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                             ...
                                                                             href=""
                                                                             style="height:30px; v-text-anchor:middle; width:232px;"
                                                                             arcsize="13.5%" stroke="f"
                                                                             fillcolor="#ff6600">
                                                                    <w:anchorlock/>
                                                                    <center
                                                                        style="color:#FFFFFF;font-family:'Cabin',sans-serif;">
                                                    <![endif]-->
                                                    <a href="{{ route('nabo.ticket-detail', $naboticket)}}" target="_blank"
                                  ...
                                  <span style="display:block;padding:8px 44px 3px 30px;line-height:120%;"><span
                                    ...
                                    <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:17px 55px 15px;font-family:'Cabin',sans-serif;"
                                                align="left">
                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 180%;"><span
                                                            style="font-size: 16px; line-height: 28.8px;">Copyrights &copy; Tier Data Ltd All Rights Reserved</span>
                                                    </p>
                                                </div>
