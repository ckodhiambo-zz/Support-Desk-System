                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:18px 10px 10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 18px; line-height: 25.2px;"><strong>PRECISION&nbsp; &nbsp;DESK&nbsp;NOTIFICATION !</strong></span>
                                                    </p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 22px; line-height: 35.2px;"><span
                                                                style="font-size: 20px; line-height: 32px;">Dear
                                                    ...
                                                    <p
                                                        style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                                    <span
                                                                        ...
                                                                        <strong>{{$ticket->status->name}}</strong>. For any complaints on this ticket, you are
                                                                        encouraged to raise a new ticket.
