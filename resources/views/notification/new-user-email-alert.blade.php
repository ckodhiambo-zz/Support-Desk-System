                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 20px; line-height: 28px;"><strong><span
                                                                    style="line-height: 28px; font-size: 20px;">ACCOUNT
                                                                                CREATION!&nbsp; </span></strong>
                                                                    </span>
                                                    </p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                                    <span
                                                                        style="font-size: 18px; line-height: 28.8px;">We
                                                                        have noticed you raised an IT Support ticket
                                                                        <strong>(TD-#{{ $ticket->id }})</strong> of subject <strong>{{ $ticket ['subject'] }})</strong> to<strong>
                                                                            support@centum.co.ke.
                                                                        </strong> Kindly click on the link
                                                                        button below to <strong>track the status of your
                                                                            ticket</strong> and <strong> explore your
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div align="center">
                                                    ...
                                                    <![endif]-->
                                                    <a href="http://support.tierdata.co.ke/login"
                                                       target="_blank" class="l-bg-red"
                                                       style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                                    <span
                                                                        style="display:block;padding:14px 44px 13px;line-height:120%;"><span
                                                                            style="font-size: 16px; line-height: 19.2px;"><strong><span
                                                                                    style="line-height: 19.2px; font-size: 16px;"> CLICK TO VIEW
                                                                                    YOUR ACCOUNT</span></strong>
                                                                        </span>
                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                        <!-- <span
                                                            style="font-size: 18px; line-height: 28.8px;"><strong>Did
                                                                you know you can raise an IT support ticket
                                                                on the <a
                                                                    href="http://support.tierdata.co.ke/nabocapital/IT-support-ticket"
                                                                    target="_blank"> same
                                                                    platform</a>?</strong>
                                                        </span> -->
                                                    </p>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:2px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="line-height: 100%; font-size: 14px;"><span
                                                            style="font-size: 18px; line-height: 18px;">Pius
                                                                        Muchiri</span>
                                                    </p>
                                                    <p style="line-height: 100%; font-size: 14px;">&nbsp;
                                                    </p>
                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 180%;"><span
                                                            style="font-size: 16px; line-height: 28.8px;">Further
                                                                        inquiries? Call +254-709-200-100.</span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 180%;"><span
                                                            style="font-size: 16px; line-height: 28.8px;">Copyrights
                                                                        &copy; Tier Data Limited All Rights
                                                                        Reserved</span>
                                                    </p>
                                                </div>
