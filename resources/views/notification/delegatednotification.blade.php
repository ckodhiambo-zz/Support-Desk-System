                                                    ...
                                                    @auth
                                                        ...
                                                        @elseif(Auth::user()->user_type==='Agent')
                                                            <li class="dropdown"><a
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <a href="{{ route('ticket.agent-assigned-tickets') }}">My
                                                                            Dashboard</a></li>
