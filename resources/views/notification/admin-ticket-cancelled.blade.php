                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:18px 10px 10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 18px; line-height: 25.2px;"><strong>P
                                                                            R E C I S I O N&nbsp; &nbsp;D E S K&nbsp; N
                                                                            O T I F I C A T I O N !</strong></span>
                                                    </p>
                                                </div>
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 28px; line-height: 39.2px;"><strong><span
                                                                    style="line-height: 39.2px; font-size: 28px;"><span
                                                                        style="font-size: 20px; line-height: 28px;">Update
                                                                                    on Ticket ID-#{{ $ticket->id
                                                                                    }}</span>&nbsp;</span>
                                                                        </strong>
                                                                    </span>
                                                    </p>
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 22px; line-height: 35.2px;"><span
                                                                style="font-size: 20px; line-height: 32px;">Hi
                                                                            {{$ticket->requester->name}}</span>, </span>
                                                    </p>
                                                    <p
                                                        style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                                    <span
                                                                        style="font-size: 18px; line-height: 28.8px;">Your
                                                                        <strong>Ticket-ID-#{{$ticket->id}}</strong>
                                                                        status now reflects as
                                                                        <strong>cancelled</strong>. The cancellation was
                                                                        initiated by our agent <strong>{{ auth()->user()->name }}</strong>. <br>
                                                                        Kindly click on the button below to view more
                                                                        details. </span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 18px; line-height: 28.8px;"><strong>Thank
                                                                            you for using Precision Desk!</strong>&nbsp;</span>
                                                    </p>
                                                </div>
                                                ...
                                                <div align="center">
                                                    ...
                                                    <a href="{{ route('admin.view-ticket-details', $ticket)}}"
                                                       ...
                                                       style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ff6600; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                                    <span
                                                                        style="display:block;padding:8px 44px 3px 30px;line-height:120%;"><span
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:17px 55px 15px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="line-height: 160%; font-size: 14px;"><span
                                                            style="font-size: 18px; line-height: 28.8px;">IT Helpdesk Team</span>
                                                    </p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 180%;"><span
                                                            style="font-size: 16px; line-height: 28.8px;">Copyrights
                                                                        &copy; Tier Data Ltd All Rights Reserved</span>
                                                    </p>
                                                </div>
