                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 20px; line-height: 28px;"><strong><span
                                                                    style="line-height: 28px; font-size: 20px;">Profile Update on Precision Desk!
                                                                            </span></strong>
                                                                    </span>
                                                    </p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                                    <span
                                                                        style="font-size: 18px; line-height: 28.8px;">We notify you that there has been an update
                                                                        on the company details associated with your account. You have been registered under <strong>{{ $user->company->company_name }}</strong> Business Unit/Company.
                                                                        </span>
                                    ...
                                    <table style="font-family:'Cabin',sans-serif;" role="presentation"
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div align="center">
                                                    <a href="{{ route('agent.dashboard.settings') }}"
                                                       target="_blank"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:14px 44px 13px;line-height:120%;"><span
                                                                            style="font-size: 16px; line-height: 19.2px;"><strong><span
                                                                                    style="line-height: 19.2px; font-size: 16px;">View Profile</span></strong>
                                                                        </span>
                                                                    </span>
                                                    </a>
