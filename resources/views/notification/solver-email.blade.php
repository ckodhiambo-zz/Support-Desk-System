                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 22px; line-height: 35.2px;">Hi {{$ticket->solver->name}}, </span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 18px; line-height: 28.8px;"><strong>(Ticket ID-#{{ $ticket->id }})</strong> has been assigned to you. The ticket status now stands as <strong>{{$ticket->status->name}}</strong>. For more details on this ticket, kindly proceed and click the button below.</span>
                                                    </p>
                                                </div>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div align="center">
                                                    ...
                                                    <![endif]-->
                                                    <a href="127.0.0.1:8000/admin/dashboard/my-assigned-tickets" target="_blank"
