                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 20px; line-height: 28px;"><strong><span
                                                                    style="line-height: 28px; font-size: 20px;">New Account Notification!
                                                                            </span></strong>
                                                                    </span>
                                                    </p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 22px; line-height: 35.2px;">Hi
                                                                        <strong>{{$newUser->name}},</strong></span>
                                                    </p>
                                                    <p
                                                        style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                                    <span
                                                                        style="font-size: 18px; line-height: 28.8px;">Thank you for registering with Precision Desk.
                                                                        Now you can use Precision Desk to capture any IT related support issue that's important to you, and you can easily track
                                                                        your status. <br>
                                                                        If you have any questions regarding Precision Desk, you can reach out to us via <strong>support@centum.co.ke</strong> or call <strong>0709902800</strong>
                                                                        </span>
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:14px 44px 13px;line-height:120%;"><span
                                                                            style="font-size: 16px; line-height: 19.2px;"><strong><span
                                                                                    style="line-height: 19.2px; font-size: 16px;">Proceed
                                                                                    and Check Details</span></strong>
                                                                        </span>
                                                                    </span>
                                                    </a>
                                                    <!--[if mso]></center></v:roundrect></td></tr></table>
                                                    <![endif]-->
                                                </div>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:2px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="line-height: 100%; font-size: 14px;"><span
                                                            style="font-size: 18px; line-height: 18px;">IT support desk</span>
                                                    </p>
                                                    <p style="line-height: 100%; font-size: 14px;">&nbsp;
                                                    </p>
                                                </div>
