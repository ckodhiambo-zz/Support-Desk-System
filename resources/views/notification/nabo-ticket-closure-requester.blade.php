                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><strong>NABO PRECISION TICKET UPDATE                                                            DESK NOTIFICATION!</strong></p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                            style="font-size: 20px; line-height: 28px;"><strong><span
                                                                    style="line-height: 28px; font-size: 20px;">Status Update of Ticket ID-#{{$naboticket->id}}&nbsp; </span></strong>
                                  </span>
                                                    </p>
                                                </div>
                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                            style="font-size: 22px; line-height: 35.2px;">Hi {{$naboticket->requester->name}}, </span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 160%; text-align: justify;">
                                                        <span style="font-size: 18px; line-height: 28.8px;">Your ticket request<strong> (Ticket ID-#{{$naboticket->id}}) </strong>has been <strong>resolved</strong>. The ticket status now stands as <strong>{{$naboticket->status->name}}</strong>.</span>
                                                    </p>
                                                </div>
