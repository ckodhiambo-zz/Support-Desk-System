...
{{--                                                style="font-size: medium">Ticket </h3>--}}
{{--                                            <div class="row">--}}
...
{{--                                                                </thead>--}}
{{--                                                                <tbody>--}}
{{--                                                                @foreach($->where('ticket_id', $ticket->id) as $index => $row)--}}
{{--                                                                    <tr>--}}
{{--                                                                        <td>{{ $row->old_status }}</td>--}}
{{--                                                                        <td>{{ $row->new_status }}</td>--}}
{{--                                                                        <td>{{ $row->created_at }}</td>--}}
{{--                                                                        --}}{{-- Calculate the di   fference in days and concat with difference in hours in minutes between the times in the current iteration and previous provided you are not at the first record--}}

{{--                                                                        <td>{{ $loop->first ? '-' :--}}

{{--                                                                                    \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->created_at)->diffInDays(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $->where('ticket_id', $ticket->id)->values()[$loop->index - 1]->created_at)) . ' days' . ' ' .--}}
{{--                                                                                    \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->created_at)->diffInHours(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $->where('ticket_id', $ticket->id)->values()[$loop->index - 1]->created_at)) . ' hours' . ' ' .--}}
{{--                                                                                    \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->created_at)->diffInMinutes(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $->where('ticket_id', $ticket->id)->values()[$loop->index - 1]->created_at)) . ' minutes' . ' ' .--}}
{{--                                                                                    \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->created_at)->diffInSeconds(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $->where('ticket_id', $ticket->id)->values()[$loop->index - 1]->created_at)) . ' seconds'}}--}}
{{--                                                                        </td>--}}
{{--                                                                    </tr>--}}
{{--                                                                @endforeach--}}
{{--                                                                </tbody>--}}
                                                            ...
                                                            <table class="table table-striped">
                                                                ...
                                                                @foreach($history->where('ticket_id', $ticket->id) as $index => $row)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $loop->first ? '-' :
                                                                                    \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->created_at)->diffInDays(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $history->where('ticket_id', $ticket->id)->values()[$loop->index - 1]->created_at)) . ' days' . ' ' .
                                                                                    \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->created_at)->diffInHours(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $history->where('ticket_id', $ticket->id)->values()[$loop->index - 1]->created_at)) . ' hours' . ' ' .
                                                                                    \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->created_at)->diffInMinutes(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $history->where('ticket_id', $ticket->id)->values()[$loop->index - 1]->created_at)) . ' minutes' . ' ' .
                                                                                    \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->created_at)->diffInSeconds(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $history->where('ticket_id', $ticket->id)->values()[$loop->index - 1]->created_at)) . ' seconds'}}
                                                                        </td>
                                                                    </tr>
                                                                @endforeach </tbody>
                                                            </table>
