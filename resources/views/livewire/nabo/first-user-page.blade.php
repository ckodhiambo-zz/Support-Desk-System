                    ...
                    <div class="row">
                        <div class="col-lg-6 border-right">
                            ...
                            <div class="text-center mt-3">
                                <span class="bg-info p-1 px-4 rounded text-white">#</span>

                                <h5 class="mt-4 mb-0"># | User-ID: #</h5>
                                <br>
                                <div class="col-sm-12">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-primary" id="exampleModalLabel">Edit #'s
                                        Profile</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    {{--                                        <input type="text" class="form-control form-control-sm"--}}
                                    {{--                                               placeholder="e.g Login Issue" name="tier_level"--}}
                                    {{--                                               aria-label="Subject">--}}
                                    {{--                                    </div>--}}
                                    {{--                                    <div class="form-group">--}}
                                    {{--                                        <strong><label class="text-primary">Department</label></strong>--}}
                                    {{--                                        <input type="text" class="form-control form-control-sm"--}}
                                    {{--                                               placeholder="e.g Login Issue" name="tier_level"--}}
                                    {{--                                               aria-label="Subject">--}}
                                    {{--                                    </div>--}}
                                    ...
                                    <div class="form-group">
                                        <strong><label class="col-form-label text-primary">Role <br> <span class="text-danger">[Current Role assigned -> #]</span></label></strong>
                                        <div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn l-bg-cherry text-white">Save Changes</button>
                                </div>
                            </div>
                        </div>
                    </div>
